...
} from '../_actions/deckEditor.actions';
...
export interface DeckEditorReducerState {
...
export const deckEditorReducer = (state = initialState, action: ReduxAction): DeckEditorReducerState => {
    switch(action.type){
...
const initialState: DeckEditorReducerState = {
    viewMode: "grouped",
