...
namespace Carpentry.Data.Implementations
{
	...
	JOIN		Sets s
        ...
        //This queries relevant data for the trimming tool
        //It's an example of why this data layer should be purged.  This query could easily be moved to a logic layer instead
        public async Task<List<TrimmingToolResult>> TrimmingToolQuery(string setCode, int minCount, string searchGroup = null)
        {
