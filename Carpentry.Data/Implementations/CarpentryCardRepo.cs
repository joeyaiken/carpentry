...
{
    public class CarpentryCardRepo : ICardRepo
    {
        //readonly ScryfallDataContext _scryContext;
        private readonly CarpentryDataContext _cardContext;
        private readonly ILogger<CarpentryCardRepo> _logger;

        public CarpentryCardRepo(CarpentryDataContext cardContext, ILogger<CarpentryCardRepo> logger)
        {
        ...
        public async Task<int> AddOrUpdateCardSet(CardSet setData)
        {
        ...
        public void AddOrUpdateCardDefinitionBatch(List<CardDataDto> cardBatch)
        {
            //TODO - condiser actually implementing this
            throw new NotImplementedException();
        }


        public async Task AddOrUpdateCardDefinition(CardDataDto cardDto)
        {
