...
namespace Carpentry.Data.MigrationTool
{
    public class DataMigrationService : IDataMigrationService
    {
        ...
        public async Task BackupDB()
        {
            ...
            await System.IO.File.WriteAllTextAsync(_config.DeckBackupLocation, deckBackupObj.ToString());
            await System.IO.File.WriteAllTextAsync(_config.CardBackupLocation, cardBackupObj.ToString());
            await System.IO.File.WriteAllTextAsync(_config.PropsBackupLocation, propsBackupObj.ToString());
