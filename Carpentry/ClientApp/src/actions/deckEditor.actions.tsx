...
import { api_Decks_Get, api_Decks_Update, api_Decks_RemoveCard } from './api';
...
export const requestDeleteDeckCard = (deckCardId: number): any => {
    return (dispatch: Dispatch, getState: any) => {
        return deleteCard(dispatch, getState(), deckCardId);
    }
};
function deleteCard(dispatch: Dispatch, state: AppState, deckCardId: number): any {
