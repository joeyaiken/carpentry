...
export const something = (state: any, action: ReduxAction): any => {
    switch(action.type){
        case CS_ACTION_APPLIED:
            return {
                ...state
            }
        case CS_CARD_SELECTED:
            return {
                ...state
            }
        case CS_FILTER_CHANGED:
            return {
                ...state
            }
        case CS_INITIALIZED:
...
export const cardSearchOld = (state: ICardSearch, action: ReduxAction): any => {
    switch(action.type){
